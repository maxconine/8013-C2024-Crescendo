...
// drive_to_intake = new SwerveTrajectoryAction(drive_to_intake_path,
// Rotation2d.fromDegrees(180.0)); // Switches
// // to
// // zero
// ShuffleBoardInteractions.getInstance().mFieldView.addTrajectory("Traj",
// drive_to_intake_path);

// drive_to_score_path = AutoTrajectoryReader.generateTrajectoryFromFile(path2,
// Constants.AutoConstants.createConfig(4.5, 1.8, 0.0, 0.0));
// drive_to_score = new SwerveTrajectoryAction(drive_to_score_path,
// Rotation2d.fromDegrees(0.0)); // Switches
// // to 180
// ShuffleBoardInteractions.getInstance().mFieldView.addTrajectory("Traj2",
// drive_to_score_path);

// // drive_to_second_pickup_path =
// AutoTrajectoryReader.generateTrajectoryFromFile(path3,
// // Constants.AutoConstants.createConfig(5.0, 2.5, 0.0, 0.0));
// // drive_to_second_pickup = new
// SwerveTrajectoryAction(drive_to_second_pickup_path,
// // Rotation2d.fromDegrees(180.0));
// // ShuffleBoardInteractions.getInstance().mFieldView.addTrajectory("Traj3",
// drive_to_second_pickup_path);

// // drive_to_retreat_path =
// AutoTrajectoryReader.generateTrajectoryFromFile(path4,
// // Constants.AutoConstants.createConfig(5.0, 2.5, 0.0, 0.0));
// // retreat_action = new SwerveTrajectoryAction(drive_to_retreat_path,
// // Rotation2d.fromDegrees(320.0));
// // ShuffleBoardInteractions.getInstance().mFieldView.addTrajectory("Traj4",
// drive_to_retreat_path);
// }
...
// drive_to_intake_path.getInitialPose().getTranslation();
