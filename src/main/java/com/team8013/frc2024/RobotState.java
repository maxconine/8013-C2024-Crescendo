...
// // public static final Pose2d kDefaultFieldRelativeGoalLocation = new
// Pose2d(8.2296, 4.12155, new Rotation2d());
// // public static final Pose2d kFiveBallStartingLocation = new Pose2d(8.597,
// 1.529, new Rotation2d());
...
// * forwards
// *
// * 3. Camera frame: origin is the center of the Limelight imager relative to
// the
// * turret.
// *
...
// */
// public synchronized void reset(double start_time, Pose2d
// initial_field_to_vehicle) {
// field_to_vehicle_ = new InterpolatingTreeMap<>(kObservationBufferSize);
// field_to_vehicle_.put(new InterpolatingDouble(start_time),
// initial_field_to_vehicle);
...
// public synchronized Map.Entry<InterpolatingDouble, Pose2d>
...
// public synchronized void addFieldToVehicleObservation(double timestamp,
// Pose2d observation) {
// field_to_vehicle_.put(new InterpolatingDouble(timestamp), observation);
// }

// public synchronized void addObservations(double timestamp, Pose2d
// displacement, Pose2d measured_velocity,
...
// // if target detected by limelight is in the positive y values and the target
// corner height is above the limelight
...
// // public synchronized Optional<AimingParameters>
// getDefaultAimingParameters() {
...
// SmartDashboard.putString("Robot Field to Vehicle",
// getLatestFieldToVehicle().getValue().toString());
// SmartDashboard.putNumber("Robot Field To Vehicle X",
// getLatestFieldToVehicle().getValue().getTranslation().x());
// SmartDashboard.putNumber("Robot Field To Vehicle Y",
// getLatestFieldToVehicle().getValue().getTranslation().y());
// SmartDashboard.putNumber("Robot Field To Vehicle Theta",
// getLatestFieldToVehicle().getValue().getRotation().getDegrees());
// SmartDashboard.putString("Smoothed Predicted Velocity",
// getSmoothedPredictedVelocity().toString());
