...
// private final boolean mUseSmartdash = false; // if we want to manual control
// lights using shuffleboard
// private boolean mLastUpdatedTop = false; // alternate updating sections to
// avoid overrunning the CANdle
...
// private Animation mRedAllianceAnimation = new ColorFlowAnimation(255, 0, 0,
// 0, 0.5, 40, Direction.Forward);
// private Animation mBlueAllianceAnimation = new ColorFlowAnimation(0, 0, 255,
// 0, 0.5, 40, Direction.Backward);
// private Animation mNoAllianceAnimation = new ColorFlowAnimation(185, 64, 255,
// 0, 0.5, 40, Direction.Backward);
// private Animation mChampsRainbowAutoAnimation = new RainbowAnimation(1.0,
// 1.0, 40);
...
// SOLID_PURPLE("SOLID_PURPLE", Double.POSITIVE_INFINITY, new Color(196, 18,
// 255)),
// SOLID_ORANGE("SOLID_ORANGE", Double.POSITIVE_INFINITY, new Color(255, 53,
// 13)),
// SOLID_YELLOW("SOLID_YELLOW", Double.POSITIVE_INFINITY, new Color(255, 150,
// 5)),
...
// FLASHING_PURPLE("FLASHING_PURPLE", 0.05, new Color(255, 0, 255),
// Color.off()),
// FLASHING_ORANGE("FLASHING_ORANGE", 0.05, new Color(255, 53, 0), Color.off()),
// FLASHING_YELLOW("FLASHING_YELLOW", 0.05, new Color(255, 247, 5),
// Color.off()),
...
// applyStates(mTopStateChooser.getSelected(),
// mBottomStateChooser.getSelected());
// }
// }
...
// if (timestamp - mLeftBottomStatus.lastSwitchTime >=
// mLeftBottomStatus.state.interval) {
...
// mCandle.setLEDs(bottomColor.r, bottomColor.g, bottomColor.b, 0,
// mLeftBottomStatus.startIDx,
// mLeftBottomStatus.LEDCount);

// mCandle.setLEDs(bottomColor.r,
// bottomColor.g, bottomColor.b, 0, mRightBottomStatus.startIDx,
// mRightBottomStatus.LEDCount);
...
// mCandle.setStatusFramePeriod(CANdleStatusFrame.CANdleStatusFrame_Status_1_General,
// 255);
// mCandle.setControlFramePeriod(CANdleControlFrame.CANdle_Control_1_General,
// 10);
// mCandle.setControlFramePeriod(CANdleControlFrame.CANdle_Control_2_ModulatedVBatOut,
// 255);
// }
...
// SmartDashboard.putString("Top LED Colors",
// mTopStatus.getWantedColor().toString());
// SmartDashboard.putString("Bottom LED Colors",
// mLeftBottomStatus.getWantedColor().toString());
// }
