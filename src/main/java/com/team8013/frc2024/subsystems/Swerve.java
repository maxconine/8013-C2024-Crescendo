...
// import com.team8013.frc2023.Robot;
...
// import com.team8013.frc2023.Constants.SwerveConstants;
// import com.team8013.frc2023.Constants.SwerveConstants.*;
...
// mOdometry = new SwerveDriveOdometry(SwerveConstants.kKinematics,
// getModuleStates());
// mMotionPlanner = new DriveMotionPlanner();

// mPigeon.setYaw(0.0);

// LoggingSystem.getInstance().registerObject(SwerveModule.class, mModules[0],
// "MOD_0");
// LoggingSystem.getInstance().registerObject(SwerveModule.class, mModules[1],
// "MOD_1");
// LoggingSystem.getInstance().registerObject(SwerveModule.class, mModules[2],
// "MOD_2");
// LoggingSystem.getInstance().registerObject(SwerveModule.class, mModules[3],
// "MOD_3");
// }
...
// double omega =
// mMotionPlanner.calculateRotationalAdjustment(mPeriodicIO.heading_setpoint.getRadians(),
...
// mPeriodicIO.des_module_states[i] =
...
// SwerveConstants.kKinematics.toChassisSpeeds(mPeriodicIO.meas_module_states);
// mPeriodicIO.heading = mPigeon.getYaw();
// mPeriodicIO.pitch = mPigeon.getPitch();

// smoothed_pitch_velocity.addNumber((mPeriodicIO.pitch.getDegrees() -
// last_pitch) / Constants.kLooperDt);
...
// Pose2d robot_pose_vel = new
// Pose2d(mPeriodicIO.des_chassis_speeds.vxMetersPerSecond *
// Constants.kLooperDt,
// mPeriodicIO.des_chassis_speeds.vyMetersPerSecond * Constants.kLooperDt,
// Rotation2d.fromRadians(mPeriodicIO.des_chassis_speeds.omegaRadiansPerSecond *
// Constants.kLooperDt));
...
// if (mControlState == DriveControlState.PATH_FOLLOWING) {
// ModuleState[] real_module_setpoints =
// SwerveConstants.kKinematics.toModuleStates(wanted_speeds);
// mPeriodicIO.des_module_states = real_module_setpoints;
// return;
// }

// // Limit rotational velocity
// wanted_speeds.omegaRadiansPerSecond =
// Math.signum(wanted_speeds.omegaRadiansPerSecond)
// * Math.min(mKinematicLimits.kMaxAngularVelocity,
// Math.abs(wanted_speeds.omegaRadiansPerSecond));

// // Limit translational velocity
// double velocity_magnitude =
// Math.hypot(mPeriodicIO.des_chassis_speeds.vxMetersPerSecond,
// mPeriodicIO.des_chassis_speeds.vyMetersPerSecond);
// if (velocity_magnitude > mKinematicLimits.kMaxDriveVelocity) {
// wanted_speeds.vxMetersPerSecond = (wanted_speeds.vxMetersPerSecond /
// velocity_magnitude)
// * mKinematicLimits.kMaxDriveVelocity;
// wanted_speeds.vyMetersPerSecond = (wanted_speeds.vyMetersPerSecond /
// velocity_magnitude)
// * mKinematicLimits.kMaxDriveVelocity;
// }

// ModuleState[] prev_module_states = mPeriodicIO.des_module_states.clone(); //
// Get last setpoint to get
// // differentials
// ChassisSpeeds prev_chassis_speeds =
// SwerveConstants.kKinematics.toChassisSpeeds(prev_module_states);
// ModuleState[] target_module_states =
// SwerveConstants.kKinematics.toModuleStates(wanted_speeds);
...
// double dx = wanted_speeds.vxMetersPerSecond -
// prev_chassis_speeds.vxMetersPerSecond;
// double dy = wanted_speeds.vyMetersPerSecond -
// prev_chassis_speeds.vyMetersPerSecond;
// double domega = wanted_speeds.omegaRadiansPerSecond -
// prev_chassis_speeds.omegaRadiansPerSecond;
...
// double max_omega_step = mKinematicLimits.kMaxAngularAccel *
// Constants.kLooperDt;
...
// } else if (mControlState == DriveControlState.PATH_FOLLOWING || mControlState
// == DriveControlState.VELOCITY
// ||
...
// public void resetOdometryWithoutHeading(Pose2d pose) {
// odometryReset = true;
// Pose2d wanted_pose = pose;
// Rotation2d wantedRotationReset = pose.getRotation();
// if (Robot.flip_trajectories) {
...
// public Rotation2d getUnajustedYaw() {
// return mPigeon.getUnadjustedYaw();
// }
...
// // public void outputTelemetryDisabled(){
// // for (SwerveModule module : mModules) {
// // module.outputTelemetryDisabledPeriodic();
// // }
// // }
...
// return
// mMotionPlanner.getRotationalError(getPose().getRotation().getDegrees());
// }
...
// Constants.SwerveConstants.maxAngularVelocity; // rad/s
...
// /*
// * The robot drives onto the Charging Station (Ramp is pushed into tilted
// state)
// */
// private Request driveOntoPlatformRequest() {
// return new Request() {

// private DelayedBoolean on_platform = new
// DelayedBoolean(Timer.getFPGATimestamp(), 0.4);
...
// @Override
// public boolean isFinished() {
// boolean maybe_on_platform = Util.epsilonEquals(platform_trigger_angle,
// getPitch(), 3.0)
// && smoothed_pitch_velocity.getAverage() < (balance_trigger_velocity * 0.85);
// return on_platform.update(Timer.getFPGATimestamp(), maybe_on_platform) ||
